...
namespace rm_modloader {
    ...
    RubyValue(__cdecl* rb_get_module)(const char* name) = nullptr;
    RubyValue(__cdecl* rb_register_module_method)(RubyValue object, const char* name, void* func, int arg_count) = nullptr;
    RubyValue(__cdecl* rb_register_method)(RubyValue object, const char* name, void* func, int arg_count) = nullptr;
    ...
    void init_functionset() {
        ...
        rb_get_module = at_offset<decltype(rb_get_module)>(rgss_module, 0x5E990);
        rb_register_module_method = at_offset<decltype(rb_register_module_method)>(rgss_module, 0x5F1E0);
